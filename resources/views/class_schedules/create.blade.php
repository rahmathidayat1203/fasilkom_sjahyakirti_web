    ...
    <div class="container">
        ...
        <form action="{{ route('class-schedules.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select class="form-control @error('lecturer_id') is-invalid @enderror" id="lecturer_id" name="lecturer_id"
                    required>
            ...
            <div class="form-group">
                ...
                <select class="form-control @error('class_type') is-invalid @enderror" id="class_type" name="class_type"
                    ...
                    <option value="practice" {{ old('class_type') == 'practice' ? 'selected' : '' }}>Practice</option>
                </select>
                @error('class_type')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
